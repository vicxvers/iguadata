...
function resolveRoute(path) {
  ...
  if (path.startsWith('/entitats/')) return {
    tab: 'entitat',
    canonicalPath: path
  };
  ...
  if (path.startsWith('/analisi/dependencia/')) return {
    tab: 'cas-dependencia',
    canonicalPath: path
  };
  return {
...
const DATA_TABS = ['buscador', 'empreses', 'persones', 'contracte', 'empresa', 'analisi', 'cas-fraccionament', 'cas-concentracio', 'cas-electoralisme', 'cas-dependencia', 'cas-investigacio'];
const ANALYSIS_TABS = ['analisi', 'cas-fraccionament', 'cas-concentracio', 'cas-electoralisme', 'cas-dependencia'];
...
function useIguadataData(activeTab) {
  ...
  useEffect(() => {
    ...
    fetchJsonDataset('/json/subvencions.json', 'Subvencions').then(data => {
      if (cancelled) return;
  ...
  useEffect(() => {
    ...
    Promise.all([fetchJsonDataset('/json/fraccionament.json', 'Fraccionament'), fetchJsonDataset('/json/concentracio.json', 'Concentracio'), fetchJsonDataset('/json/electoralisme.json', 'Electoralisme'), fetchJsonDataset('/json/dependencia.json', 'Dependència')]).then(([fraccionamentData, concentracioData, electoralismeData, dependenciaData]) => {
      if (cancelled) return;
  ...
  const activeDataError = DATA_TABS.includes(activeTab) && coreDataError || activeTab === 'persones' && personesError || activeTab === 'empresa' && administradorsError || activeTab === 'cas-investigacio' && investigacioError || SUBVENTION_TABS.includes(activeTab) && subvencionsError || ANALYSIS_TABS.includes(activeTab) && analisiError;
  const supplementalDataLoading = activeTab === 'persones' && !personesLoaded || activeTab === 'empresa' && !administradorsLoaded || activeTab === 'cas-investigacio' && !investigacioLoaded || SUBVENTION_TABS.includes(activeTab) && !subvencionsLoaded || ANALYSIS_TABS.includes(activeTab) && !analisiLoaded;
  const isDataTabLoading = DATA_TABS.includes(activeTab) && (!coreDataLoaded || dataLoading || supplementalDataLoading) || SUBVENTION_TABS.includes(activeTab) && supplementalDataLoading;
...
function CasDependenciaView({
  ...
  return React.createElement("div", {
    ...
    className: "page-title"
  }, "Detall de depend\xE8ncia"), React.createElement("div", {
    className: "analisi-detail-hero analisi-case-hero analisi-case-dependencia"
  }, React.createElement("div", {
    className: "analisi-case-amount"
  }, formatCurrency(caso.import_total)), React.createElement("div", {
    className: "contract-header analisi-case-header analisi-fraccionament-title-row"
    ...
    href: buildRouteUrl(`/entitats/${caso.entitat_slug}`),
    className: "analisi-case-title-link"
  }, caso.entitat))), React.createElement("div", {
    className: "analisi-detail-contract-count"
  }, caso.num_subvencions, " subvencions directes"), React.createElement("div", {
    className: "contract-pills analisi-detail-hero-pills"
  }, React.createElement("span", {
    className: "risk-badge " + riskClass(caso.nivell)
  }, riskLabel(caso.nivell)), React.createElement("span", {
  ...
  }, caso.risc, "/100"))), React.createElement("div", {
    className: "analisi-detail-info-card"
  }, React.createElement("div", {
    className: "contract-meta analisi-detail-info-meta analisi-detail-info-meta-dependencia"
  }, React.createElement("div", {
    className: "contract-meta-item"
  }, React.createElement("span", {
    className: "contract-meta-label"
    ...
    className: "contract-meta-label"
  }, "Mitjana anual"), React.createElement("span", {
    className: "contract-meta-value"
  }, formatCurrency(annualDependenciaStats.average))), React.createElement("div", {
    className: "contract-meta-item"
  }, React.createElement("span", {
    className: "contract-meta-label"
  }, "M\xE0xim anual"), React.createElement("span", {
    className: "contract-meta-value"
  }, formatCurrency(annualDependenciaStats.maximum))))), React.createElement("section", {
    className: "analisi-detail-section-card",
    "aria-labelledby": "dependencia-indicators-title"
  }, React.createElement("h2", {
    id: "dependencia-indicators-title",
    className: "analisi-detail-section-title"
  }, "Indicadors"), React.createElement("ul", {
    className: "analisi-detail-text-list"
  }, (caso.motius || []).map(motiu => React.createElement("li", {
    key: motiu
  }, motiu)))), (caso.subvencions || []).map(subvencio => React.createElement("div", {
    key: subvencio.id,
    className: "contract-card"
  }, React.createElement("div", {
    className: "contract-header"
    ...
    className: "contract-title"
  }, subvencio.descripcion), React.createElement("div", {
    className: "contract-amount"
  }, formatCurrency(subvencio.importe))), React.createElement("div", {
    className: "contract-meta"
  }, React.createElement("div", {
    className: "contract-meta-item"
  }, React.createElement("span", {
    ...
    className: "contract-meta-value"
  }, formatDate(subvencio.fecha))), React.createElement("div", {
    className: "contract-meta-item"
  }, React.createElement("span", {
    className: "contract-meta-label"
  }, "Codi expedient"), React.createElement("span", {
    className: "contract-meta-value"
  }, subvencio.codigo)), React.createElement("div", {
    className: "contract-pills"
  }, React.createElement("span", {
    className: "contract-pill"
  }, formatSubvencioSector(subvencio.finalitat_p_blica)))))), React.createElement("div", {
    className: "contracte-detail-actions-row"
  }, React.createElement("button", {
    onClick: onBack,
    className: "btn-share contracte-detail-back",
    ...
    id: "dependencia-share-actions",
    className: "contracte-detail-share-actions",
    "aria-hidden": !shareActionsOpen
  }, React.createElement("button", {
    className: "btn-share contracte-detail-share-btn",
    onClick: copyDependenciaLink,
    tabIndex: shareActionsOpen ? 0 : -1,
    type: "button"
  }, shareCopyStatus || "Copia l'enllaç")), React.createElement("button", {
    className: "btn-share contracte-detail-share-btn",
    onClick: () => setShareActionsOpen(open => !open),
    "aria-expanded": shareActionsOpen,
    "aria-controls": "dependencia-share-actions",
    type: "button"
  }, React.createElement("em", {
    className: "share-arrow"
  }), " Compartir"))));
...
function EmpresaView({
  ...
  return React.createElement("div", {
    ...
    value: searchTerm,
    onValueChange: setSearchTerm,
    placeholder: "Cerca per descripci\xF3 o codi d'expedient",
    ariaLabel: "Cerca per descripci\xF3 o codi d'expedient"
  }), React.createElement(FilterActions, {
...
function HomeSection({
  ...
  interactive = true,
  homeCanvasRef,
  handleHomeMetricLinkClick,
  handleNavigation,
  setIsMobileMenuOpen,
  handleAnalisiNavClick,
  contractCount,
  subvencionsCount,
  empresasCount,
  personesCount,
  ...
  return React.createElement("section", {
    ...
    className: "home-deck"
  }, "Contractes, empreses, persones, subvencions i an\xE0lisi en una cartografia oberta de la contractaci\xF3 p\xFAblica de ", AUTHORITY_NAME)), React.createElement("div", {
    ...
    className: "home-metric-value"
  }, subvencionsCount.toLocaleString('ca-ES')), React.createElement("span", {
    className: "home-metric-label"
...
function SobreView() {
  return React.createElement("div", {
  ...
  }, BRAND_NAME, " \xE9s la plataforma independent de periodisme de dades per a l'an\xE0lisi de la contractaci\xF3 p\xFAblica i les subvencions de ", AUTHORITY_NAME, " i dels seus organismes municipals.", React.createElement("br", null), React.createElement("br", null), "El projecte combina dades obertes de contractaci\xF3 i subvencions, informaci\xF3 mercantil i algoritmes propis per fer m\xE9s accessible, comprensible i fiscalitzable la despesa p\xFAblica municipal."), React.createElement("h2", {
    ...
    className: "prose-paragraph"
  }, "Iguadata neix amb tres objectius principals: facilitar l'acc\xE9s de la ciutadania a la contractaci\xF3 i les subvencions p\xFAbliques municipals, detectar patrons que puguin mer\xE8ixer revisi\xF3 period\xEDstica o institucional, i construir una metodologia replicable per altres municipis."), React.createElement("p", {
    className: "prose-paragraph"
    ...
    className: "prose-paragraph"
  }, "Iguadata permet consultar contractes, empreses adjudicat\xE0ries, persones vinculades a aquestes empreses, subvencions, entitats benefici\xE0ries i diferents indicadors d'an\xE0lisi."), React.createElement("p", {
    className: "prose-paragraph"
  }, "Els principals blocs d'an\xE0lisi s\xF3n el possible fraccionament de contractes menors, la concentraci\xF3 d'adjudicacions en determinades empreses o sectors, els patrons d'electoralisme o comunicaci\xF3 institucional en per\xEDodes sensibles i l'acumulaci\xF3 o recurr\xE8ncia de subvencions directes en una mateixa entitat."), React.createElement("h2", {
    className: "prose-heading"
  }, "Font de dades"), React.createElement("p", {
    className: "prose-paragraph"
  }, "Les dades de contractaci\xF3 provenen del Registre P\xFAblic de Contractes de la Generalitat de Catalunya, consultat mitjan\xE7ant l'API Socrata Open Data (SODA)."), React.createElement("p", {
    className: "prose-paragraph"
  }, "Les dades de subvencions provenen del Registre d'Ajuts i Subvencions de Catalunya (RAISC). Iguadata selecciona les concessions emeses per ", AUTHORITY_NAME, " i publica \xFAnicament els registres amb beneficiaris identificats com a entitats publicables."), React.createElement("p", {
    className: "prose-paragraph"
    ...
    className: "prose-paragraph"
  }, "Una actualitzaci\xF3 autom\xE0tica setmanal genera una fotografia coherent dels contractes, les subvencions, les empreses, les entitats, les persones i els resultats anal\xEDtics. Tamb\xE9 es generen fitxers JSON propis que permeten alimentar la interf\xEDcie, accelerar la consulta i mantenir c\xF2pies de suport en cas de caiguda temporal de les fonts externes."), React.createElement("h2", {
    className: "prose-heading"
  }, "Metodologia"), React.createElement("p", {
    className: "prose-paragraph"
    ...
    className: "prose-paragraph"
  }, "Les dades poden contenir errors d'origen, omissions, duplicats, canvis posteriors o incid\xE8ncies derivades de la normalitzaci\xF3 i classificaci\xF3 automatitzades. L'aparici\xF3 d'una empresa, entitat, persona, contracte o subvenci\xF3 en una alerta no implica cap irregularitat legal confirmada."), React.createElement("p", {
    className: "prose-paragraph"
  }, "Qualsevol conclusi\xF3 period\xEDstica, administrativa o jur\xEDdica requereix contrastar les dades amb expedients originals, informes t\xE8cnics, resolucions, convocat\xF2ries, bases reguladores, plecs i altres fonts documentals."), React.createElement("h2", {
    className: "prose-heading"
...
function LegalView() {
  return React.createElement("div", {
    ...
    className: "prose-paragraph"
  }, BRAND_NAME, " \xE9s un projecte independent de transpar\xE8ncia, an\xE0lisi de dades p\xFAbliques i fiscalitzaci\xF3 c\xEDvica de la contractaci\xF3 i les subvencions p\xFAbliques vinculades a ", AUTHORITY_NAME, " i als seus organismes municipals relacionats."), React.createElement("p", {
    className: "prose-paragraph"
    ...
    className: "prose-paragraph"
  }, "Les dades de subvencions provenen del Registre d'Ajuts i Subvencions de Catalunya (RAISC). Iguadata selecciona les concessions emeses per ", AUTHORITY_NAME, " i processa la informaci\xF3 sobre els imports, les finalitats, els procediments de concessi\xF3 i els beneficiaris que poden ser objecte de publicaci\xF3."), React.createElement("p", {
    className: "prose-paragraph"
    ...
    className: "prose-paragraph"
  }, "La plataforma publica fotografies setmanals coherents de contractes i subvencions generades a partir de fonts p\xFAbliques. Part del proc\xE9s d'actualitzaci\xF3 s'executa de manera automatitzada mitjan\xE7ant GitHub Actions, amb controls t\xE8cnics de validaci\xF3, preservaci\xF3 de registres, c\xF2pies de seguretat i comprovacions d'integritat dels fitxers generats."), React.createElement("p", {
    className: "prose-paragraph"
    ...
    className: "prose-paragraph"
  }, "La finalitat d'Iguadata \xE9s facilitar l'acc\xE9s, la comprensi\xF3 i l'an\xE0lisi de dades p\xFAbliques sobre contractaci\xF3 i subvencions municipals, concentraci\xF3 empresarial, vincles mercantils, possibles patrons de fraccionament, indicadors de risc electoral o institucional i acumulaci\xF3 o recurr\xE8ncia de subvencions directes."), React.createElement("p", {
    className: "prose-paragraph"
    ...
    className: "prose-paragraph"
  }, "L'aparici\xF3 d'una empresa, entitat, persona, contracte o subvenci\xF3 dins d'un indicador no implica per si mateixa cap infracci\xF3 legal, administrativa, \xE8tica o penal."), React.createElement("p", {
    className: "prose-paragraph"
  }, "En particular, les alertes de depend\xE8ncia identifiquen patrons d'acumulaci\xF3 o recurr\xE8ncia de subvencions directes. Aquests patrons poden tenir inter\xE8s p\xFAblic o period\xEDstic, per\xF2 no acrediten un \xFAs indegut dels recursos p\xFAblics ni una actuaci\xF3 irregular de l'entitat benefici\xE0ria o de l'administraci\xF3 concedent."), React.createElement("h2", {
    className: "prose-heading"
    ...
    className: "prose-paragraph"
  }, "En l'\xE0mbit de les subvencions, la interf\xEDcie p\xFAblica mostra \xFAnicament els registres corresponents a beneficiaris identificats com a entitats publicables. Les concessions associades a persones f\xEDsiques o a beneficiaris no publicables es conserven nom\xE9s quan s\xF3n necess\xE0ries per al tractament intern i l'an\xE0lisi agregada, per\xF2 no es mostren ni permeten identificar-ne els beneficiaris a la plataforma p\xFAblica."), React.createElement("p", {
    className: "prose-paragraph"
    ...
    className: "prose-paragraph"
  }, "Les dades publicades es limiten a la informaci\xF3 estrictament necess\xE0ria per a la finalitat de transpar\xE8ncia i fiscalitzaci\xF3 p\xFAblica, d'acord amb el principi de minimitzaci\xF3 de dades de l'article 5.1.c del RGPD. No es publiquen dades de la vida privada, domicilis personals, documents identificatius, dades de contacte privades ni informaci\xF3 aliena a les dimensions mercantil, contractual o subvencional analitzades."), React.createElement("h2", {
    className: "prose-heading"
  }, "7. Assistent d\u2019intel\xB7lig\xE8ncia artificial"), React.createElement("p", {
    className: "prose-paragraph"
  }, "Quan una persona utilitza l\u2019assistent d\u2019Iguadata, la pregunta introdu\xEFda i una selecci\xF3 de dades p\xFAbliques relacionades amb la consulta es transmeten a l\u2019API d\u2019OpenAI exclusivament per generar la resposta. Iguadata no demana ni necessita que s\u2019hi introdueixin dades personals, confidencials o sensibles."), React.createElement("p", {
    className: "prose-paragraph"
  }, "Les peticions es configuren sense emmagatzematge de la resposta per part de l\u2019aplicaci\xF3. OpenAI pot conservar temporalment registres necessaris per prevenir abusos i garantir la seguretat del servei, d\u2019acord amb les seves pol\xEDtiques aplicables a l\u2019API. Les respostes s\xF3n generades autom\xE0ticament, poden contenir errors i s\u2019han de contrastar amb les fonts p\xFAbliques originals."), React.createElement("p", {
    className: "prose-paragraph"
  }, "Per protegir l\u2019assistent contra usos automatitzats i abusius, Iguadata utilitza Cloudflare Turnstile. Aquest mecanisme verifica el navegador abans de cada consulta i no rep el contingut de la pregunta."), React.createElement("h2", {
    className: "prose-heading"
  }, "8. Exercici de drets i correccions"), React.createElement("p", {
    className: "prose-paragraph"
    ...
    className: "prose-paragraph"
  }, "Tamb\xE9 es poden comunicar errors factuals, homon\xEDmies, atribucions incorrectes, canvis de denominaci\xF3, classificacions err\xF2nies, dades desactualitzades o incid\xE8ncies derivades del processament automatitzat."), React.createElement("p", {
    className: "prose-paragraph"
    ...
    className: "prose-heading"
  }, "9. Propietat intel\xB7lectual i codi obert"), React.createElement("p", {
    className: "prose-paragraph"
    ...
    className: "prose-heading"
  }, "10. Fonts normatives principals"), React.createElement("p", {
    className: "prose-paragraph"
  }, "El present av\xEDs legal es basa, entre altres, en el Reglament (UE) 2016/679 (RGPD), la Llei 19/2013, de transpar\xE8ncia, acc\xE9s a la informaci\xF3 p\xFAblica i bon govern, la Llei 19/2014, de transpar\xE8ncia, acc\xE9s a la informaci\xF3 p\xFAblica i bon govern de Catalunya, la Llei 38/2003, general de subvencions, i el Decret 271/2019, pel qual s'aprova el Reglament del Registre de subvencions i ajuts de Catalunya.")));
}
function CasosView({
  casos,
  onCasoSelect
...
function isSubvencioDirecta(subvencio) {
  const text = normalizeSearchText([subvencio.objecte_de_la_convocat_ria, subvencio.t_tol_convocat_ria_catal, subvencio.t_tol_convocat_ria_castell, subvencio.discriminador_de_la_concessi, subvencio.descripcion].join(' '));
  return /\bdirect(?:a|e|es)?\b/.test(text);
}
const SUBVENCIO_TIPOLOGIES = ['Serveis Socials i Promoció Social', 'Cultura', 'Comerç, Turisme i Pimes', "Accés a l'habitatge i foment de l'edificació", "Foment de l'Ocupació", 'Cooperació internacional per al desenvolupament i cultural', 'Educació', 'Sanitat', 'Altres actuacions de caràcter econòmic', 'Altres Prestacions econòmiques'];
function EntitatView({
  entitatSlug,
  subvencions,
  onBack
}) {
  const allEntitatSubvencions = useMemo(() => subvencions.filter(subvencio => subvencio.entitat_slug === entitatSlug), [subvencions, entitatSlug]);
  ...
  const principalSector = useMemo(() => {
    ...
    for (const subvencio of allEntitatSubvencions) {
      ...
      if (!sectors[finalitat]) sectors[finalitat] = {
        count: 0,
        amount: 0
      };
    ...
    return Object.entries(sectors).sort(([, a], [, b]) => b.count - a.count || b.amount - a.amount)[0]?.[0] || '';
  }, [allEntitatSubvencions]);
  ...
  return React.createElement("div", {
    className: "container empresa-detail-page entitat-detail-page"
  }, React.createElement("h1", {
    className: "page-title"
  }, "Detall d'entitat"), React.createElement("div", {
    className: "empresa-detail-hero"
  }, React.createElement("div", {
    className: "empresa-detail-amount"
  }, formatCurrency(totalImport)), React.createElement("div", {
    ...
    className: "empresa-detail-title"
  }, entitatNom)), React.createElement("div", {
    className: "empresa-detail-contract-count"
  }, allEntitatSubvencions.length, " subvencions")), React.createElement("div", {
    className: "empresa-detail-info-card"
  }, React.createElement("div", {
    className: "contract-meta empresa-detail-info-meta entitat-detail-info-meta"
  }, principalSector && React.createElement("div", {
    className: "contract-meta-item"
  }, React.createElement("span", {
    className: "contract-meta-label"
  }, "Sector"), React.createElement("span", {
    className: "contract-meta-value"
  }, formatSubvencioSector(principalSector))), React.createElement("div", {
    className: "contract-meta-item"
  }, React.createElement("span", {
    className: "contract-meta-label"
  }, "Per\xEDode"), React.createElement("span", {
    className: "contract-meta-value"
  }, annualActivity.period)), React.createElement("div", {
    className: "contract-meta-item"
  }, React.createElement("span", {
    className: "contract-meta-label"
  }, "Subvencions directes"), React.createElement("span", {
    className: "contract-meta-value"
  }, concessionTypeStats.directes, " (", formatPercent(concessionTypeStats.percentatgeDirectes), ")")), React.createElement("div", {
    className: "contract-meta-item"
  }, React.createElement("span", {
    className: "contract-meta-label"
  }, "Altres subvencions"), React.createElement("span", {
    className: "contract-meta-value"
  }, concessionTypeStats.indirectes, " (", formatPercent(1 - concessionTypeStats.percentatgeDirectes), ")")))), annualActivity.items.length > 1 && React.createElement("div", {
    className: "empresa-activity-visual",
    "aria-label": "Hist\xF2ric anual de les subvencions concedides a aquesta entitat"
  }, React.createElement("div", {
    className: "empresa-activity-header"
  }, React.createElement("h3", {
    className: "empresa-activity-title"
  }, "Hist\xF2ric de subvencions")), React.createElement("div", {
    className: "empresa-activity-bars"
  }, annualActivity.items.map(item => React.createElement("div", {
    key: item.year,
    className: "empresa-activity-column"
  }, React.createElement("div", {
    className: "empresa-activity-bar-wrap",
    ...
    style: {
      height: `${Math.max(4, Math.round(item.amount / annualActivity.maxAmount * 100))}%`,
      '--bar-width': `${Math.max(4, Math.round(item.amount / annualActivity.maxAmount * 100))}%`
    }
  })), React.createElement("div", {
    className: "empresa-activity-meta"
  }, React.createElement("span", null, item.year), React.createElement("small", null, formatCurrency(item.amount))))))), React.createElement("div", {
    ...
    className: 'filters search-filter-panel subvencio-filter-primary' + (!filtersOpen ? ' collapsed' : '')
  }, React.createElement("div", {
    className: "filter-group filter-group-standard"
  }, React.createElement("label", {
    className: "filter-label"
    ...
    "aria-label": "Ordenar subvencions de l'entitat per"
  }, React.createElement("option", {
    value: "date-desc"
  }, "Data (m\xE9s recents)"), React.createElement("option", {
    value: "date-asc"
    ...
    onChange: event => setTipologiaFilter(event.target.value),
    "aria-label": "Tipus de subvenci\xF3"
  }, React.createElement("option", {
    value: ""
  }, "Tots els tipus"), SUBVENCIO_TIPOLOGIES.map(tipologia => React.createElement("option", {
    key: tipologia,
    value: tipologia
  }, formatSubvencioSector(tipologia)))))), React.createElement("div", {
    ...
    className: "results-count-prefix"
  }, "S'han trobat "), React.createElement("strong", null, filteredSubvencions.length), " subvencions")), pageSubvencions.map(subvencio => React.createElement("div", {
    key: subvencio.id,
    ...
    className: "contract-meta-value"
  }, subvencio.codigo || '—')), React.createElement("span", {
    className: "contract-pills"
  }, React.createElement("span", {
    className: "contract-pill",
    title: subvencio.finalitat_p_blica,
    "aria-label": `Finalitat pública: ${subvencio.finalitat_p_blica}`
  }, formatSubvencioSector(subvencio.finalitat_p_blica)))))), filteredSubvencions.length === 0 && React.createElement(EmptySearchState, {
    ...
    id: "entitat-share-actions",
    className: "contracte-detail-share-actions",
    "aria-hidden": !shareActionsOpen
  }, React.createElement("button", {
    className: "btn-share contracte-detail-share-btn",
    onClick: copyEntitatLink,
    tabIndex: shareActionsOpen ? 0 : -1,
    type: "button"
  }, shareCopyStatus || "Copia l'enllaç")), React.createElement("button", {
    className: "btn-share contracte-detail-share-btn",
    onClick: () => setShareActionsOpen(open => !open),
    "aria-expanded": shareActionsOpen,
    "aria-controls": "entitat-share-actions",
    type: "button"
  }, React.createElement("em", {
    className: "share-arrow"
  }), " Compartir"))));
...
function SubvencionsView({
  ...
  return React.createElement("div", {
    ...
    className: "results-count-page-short"
  }, "P\xE0g."), " ", React.createElement("strong", null, currentPage), " de ", React.createElement("strong", null, totalPages))), pageSubvencions.map(subvencio => React.createElement("a", {
    key: subvencio.id,
    ...
    className: "metodologia-intro"
  }, "Les subvencions que apareixen en aquest cercador corresponen a les concessions publicades al Registre d'Ajuts i Subvencions de Catalunya (RAISC)."), React.createElement("p", {
    className: "metodologia-intro"
  }, "L'import que figura a cada subvenci\xF3 \xE9s la quantitat concedida publicada oficialment. La interf\xEDcie mostra \xFAnicament els registres amb beneficiaris identificats com a entitats publicables, pel que les concessions associades a persones f\xEDsiques o a beneficiaris no publicables no apareixen al cercador."), React.createElement("p", {
    className: "metodologia-intro"
  }, "El tractament de les dades es realitza a l'empara de l'article 6.1.e) del Reglament UE 2016/679 (RGPD) d'inter\xE8s p\xFAblic i de la Llei 19/2013, de 9 de desembre, de transpar\xE8ncia, acc\xE9s a la informaci\xF3 p\xFAblica i bon govern, que estableix l'obligaci\xF3 de publicitat activa en mat\xE8ria de contractaci\xF3 p\xFAblica. Les dades es limiten a la informaci\xF3 estrictament necess\xE0ria per al prop\xF2sit de transpar\xE8ncia i es tracten d'acord amb el principi de minimitzaci\xF3 de dades (art. 5.1.c RGPD). Tota la informaci\xF3 publicada prov\xE9 de fonts oficials de car\xE0cter p\xFAblic i no inclou dades de la vida privada de les persones."), React.createElement("p", {
    className: "metodologia-intro metodologia-intro-last"
  }, "Les persones interessades poden exercir els drets d'acc\xE9s, rectificaci\xF3, limitaci\xF3 o oposici\xF3 al tractament posant-se en contacte a trav\xE9s de la secci\xF3 ", React.createElement("a", {
...
const ASSISTENT_SUGGERIMENTS = ['Quins són els últims contractes?', 'Quines empreses tenen més contractes?', 'Quines entitats reben més subvencions?', 'Quines alertes tenen més risc?', 'Què ha investigat Iguadata?'];
...
const ASSISTENT_STOP_WORDS = new Set(['a', 'al', 'als', 'amb', 'de', 'del', 'dels', 'el', 'els', 'en', 'i', 'la', 'les', 'mostra', 'mostrar', 'busca', 'buscar', 'cerca', 'cercar', 'sobre', 'que', 'quins', 'quines', 'quin', 'quina', 'hi', 'ha', 'un', 'una', 'uns', 'unes', 'per', 'any', 'contracte', 'contractes', 'empresa', 'empreses', 'cas', 'casos', 'alerta', 'alertes', 'investigacio', 'investigacions', 'reportatge', 'reportatges', 'publicat', 'publicats', 'publicada', 'publicades', 'quant', 'quants', 'quanta', 'quantes', 'rebut', 'rebre', 'adjudicat', 'adjudicats', 'adjudicada', 'adjudicades', 'adjudicacio', 'adjudicacions', 'import', 'total', 'suma', 'diners', 'troba', 'dona', 'informacio', 'dades', 'relacionat', 'relacionats', 'te', 'tenen', 'fet', 'fets', 'feta', 'fetes', 'fraccionament', 'concentracio', 'electoralisme', 'dependencia', 'risc', 'hola', 'bones', 'bon', 'dia', 'tarda', 'nit', 'va', 'passar', 'diu', 'dir', 'aixo', 'aquest', 'aquesta', 'aquell', 'aquella', 'mateix', 'mateixa', 'anterior', 'explica', 'explicar', 'analitza', 'analitzar', 'saber', 'saps', 'sap', 'digues', 'parla', 'qui', 'es', 'son', 'mes', 'alt', 'alts', 'destaca', 'destaquen', 'revela', 'revelen', 'investigat', 'iguadata', 'vinculada', 'vinculades', 'persones', 'persona', 'estan', 'subvencio', 'subvencions', 'imports']);
...
function paraulesConsultaAssistent(query) {
  return normalitzaTextAssistent(query).split(' ').filter(word => word.length > 1 && !ASSISTENT_STOP_WORDS.has(word) && !/^20\d{2}$/.test(word));
}
...
function evidenciaInvestigacio(item) {
  return {
    ...
    data: item.date,
    import: item.importe,
    extracte: (item.content || []).map(block => block.text).filter(Boolean).join(' ').slice(0, 2400)
  };
}
function dadesCercaPersona(persona) {
  return [persona.nom, ...(persona.relacions || []).flatMap(relacio => [relacio.empresa, ...(relacio.carrecs || [])])];
}
...
function dadesCercaAlerta(alerta, tipus) {
  ...
  return [tipus, alerta.id, alerta.empresa, alerta.entitat, alerta.sector, alerta.empresa_dominant, ...(alerta.empreses || []), ...(alerta.motius || []), ...contracts.flatMap(contract => [contract.descripcion, contract.adjudicatario, contract.codigo])];
}
async function generaRespostaAssistent(payload, turnstileToken) {
  const localHost = ['localhost', '127.0.0.1'].includes(window.location.hostname);
  const endpoint = window.__IGUADATA_ASSISTANT_ENDPOINT__ || (localHost ? assetUrl('/api/assistent') : 'https://iguadata-assistent.vicxvers.workers.dev/api/assistent');
...
function AssistentIcona({
  ...
  if (close) {
    return React.createElement("svg", {
      ...
      d: "M2.5 2.5l19 19M21.5 2.5l-19 19"
    }));
  }
  return React.createElement("svg", {
    viewBox: "0 0 24 24",
    ...
    d: "M12 2.5c.58 6.18 3.32 8.92 9.5 9.5-6.18.58-8.92 3.32-9.5 9.5-.58-6.18-3.32-8.92-9.5-9.5 6.18-.58 8.92-3.32 9.5-9.5Z"
  }));
}
function AssistentIguadata({
  contracts: appContracts,
  empreses: appEmpreses,
  visible = true,
  closeSignal = 0
}) {
  ...
  const loadBaseData = useCallback(async () => {
    ...
    basePromiseRef.current = Promise.all([appContracts.length && appEmpreses.length ? Promise.resolve({
      contracts: appContracts,
      empreses: appEmpreses
    }) : fetchCoreData(), fetchJsonDataset('/json/investigacio.json', 'Investigacions').catch(() => []), fetchJsonDataset('/json/persones.json', 'Persones').catch(() => []), fetchJsonDataset('/json/subvencions.json', 'Subvencions').catch(() => [])]).then(([core, investigacions, persones, subvencions]) => {
      const loaded = {
        ...core,
  ...
  const loadAlertData = useCallback(async () => {
    ...
    alertPromiseRef.current = Promise.all([fetchJsonDataset('/json/fraccionament.json', 'Fraccionament'), fetchJsonDataset('/json/concentracio.json', 'Concentració'), fetchJsonDataset('/json/electoralisme.json', 'Electoralisme'), fetchJsonDataset('/json/dependencia.json', 'Dependència')]).then(([fraccionament, concentracio, electoralisme, dependencia]) => {
      const loaded = {
  ...
  const answerQuestion = async rawQuestion => {
    ...
    try {
      ...
      const isAlertContinuation = previousAlertIds.length > 0 && /alert|fraccion|elector|concentr|dependen|risc|lcsp|contract|import/.test(normalized);
      const isFollowUp = previousUserQuestion && (/^(i |el |la |els |les |aixo|aquest|aquesta|sobre |per que|com )/.test(normalized) || paraulesConsultaAssistent(query).length <= 2 || isAlertContinuation);
      ...
      const alertIds = [...new Set([...currentAlertIds, ...(isAlertContinuation ? previousAlertIds : [])])];
      ...
      if (esSalutacioAssistent(query)) {
        ...
        const contracts = base.contracts.filter(contract => !year || contract.año === year).sort((a, b) => String(b.fecha || '').localeCompare(String(a.fecha || '')));
        ...
        const contracts = base.contracts.filter(contract => !year || contract.año === year).sort((a, b) => (Number(b.importe) || 0) - (Number(a.importe) || 0));
        results = contracts.slice(0, 6).map(contract => ({
          type: 'Contracte',
          title: contract.descripcion,
          meta: `${contract.adjudicatario} · ${formatCompactCurrency(contract.importe)} · ${formatDate(contract.fecha)}`,
        ...
        const entities = Array.from(base.subvencions.reduce((groups, subvencio) => {
          ...
          return groups;
        }, new Map()).values()).sort((a, b) => b.subvencions - a.subvencions || b.import_total - a.import_total);
        ...
        const subsidies = base.subvencions.filter(subvencio => !year || subvencio.año === year).filter(subvencio => !meaningfulWords.length || coincideixConsultaAssistent(retrievalQuery, [subvencio.descripcion, subvencio.adjudicatario, subvencio.codigo, subvencio.finalitat_p_blica])).sort((a, b) => (Number(b.importe) || 0) - (Number(a.importe) || 0));
        ...
        responseText = subsidies.length ? `He trobat ${subsidies.length.toLocaleString('ca-ES')} subvencions. Et mostro les de més import${year ? ` de ${year}` : ''}.` : 'No he trobat cap subvenció que coincideixi amb la consulta.';
      } else if (wantsPeople) {
        const matches = base.persones.map(persona => ({
          persona,
          score: puntuacioAssistent(retrievalQuery, dadesCercaPersona(persona))
        })).filter(match => wantsTopPeople || coincideixConsultaAssistent(retrievalQuery, dadesCercaPersona(match.persona))).sort((a, b) => wantsTopPeople ? (b.persona.relacions?.length || 0) - (a.persona.relacions?.length || 0) : b.score - a.score || (b.persona.total_adjudicat || 0) - (a.persona.total_adjudicat || 0));
        results = matches.slice(0, 6).map(({
          persona
        }) => resultatPersona(persona));
        evidence = matches.slice(0, 8).map(({
          persona
        }) => evidenciaPersona(persona));
        responseText = matches.length ? `He trobat ${matches.length.toLocaleString('ca-ES')} persones relacionades amb la consulta. Els imports corresponen a les empreses vinculades, no a un benefici personal.` : 'No he trobat cap persona que coincideixi amb la consulta.';
      } else if (wantsTopCompanies) {
        const companies = year ? Array.from(base.contracts.filter(contract => contract.año === year).reduce((groups, contract) => {
        ...
        responseText = year ? `Aquestes són les empreses amb més contractes entre els resultats de ${year}.` : 'Aquestes són les empreses amb més contractes registrats a Iguadata.';
      } else if (wantsAlerts) {
        ...
        evidence = matches.slice(0, 10).map(({
          item,
          type
        }) => ({
          tipus: 'alerta',
        ...
        responseText = matches.length ? `He trobat ${matches.length.toLocaleString('ca-ES')} alertes relacionades. Et mostro les més rellevants.` : 'No he trobat cap alerta que coincideixi amb aquesta consulta.';
      } else if (wantsInvestigations) {
        const matches = base.investigacions.map(item => ({
          item,
          score: puntuacioAssistent(retrievalQuery, dadesCercaInvestigacio(item))
        })).filter(match => coincideixConsultaAssistent(retrievalQuery, dadesCercaInvestigacio(match.item), true)).sort((a, b) => b.score - a.score);
        results = matches.slice(0, 6).map(({
          item
        }) => resultatInvestigacio(item));
        evidence = matches.slice(0, 6).map(({
          item
        }) => evidenciaInvestigacio(item));
        responseText = matches.length ? `Iguadata té ${matches.length.toLocaleString('ca-ES')} investigacions relacionades amb la consulta.` : 'No he trobat cap investigació relacionada amb aquesta consulta.';
      } else {
        const contractMatches = base.contracts.filter(contract => !year || contract.año === year).map(contract => ({
          contract,
        ...
        })).filter(match => coincideixConsultaAssistent(retrievalQuery, [match.contract.descripcion, match.contract.adjudicatario, match.contract.codigo, match.contract.tipo, match.contract.procedimiento], Boolean(year))).sort((a, b) => b.score - a.score || (b.contract.importe || 0) - (a.contract.importe || 0));
        const companyMatches = base.empreses.map(company => ({
          company,
          score: puntuacioAssistent(retrievalQuery, [company.nom, company.sector, company.categoria])
        })).filter(match => coincideixConsultaAssistent(retrievalQuery, [match.company.nom, match.company.sector, match.company.categoria])).sort((a, b) => b.score - a.score || b.company.num_contratos - a.company.num_contratos);
        const investigationMatches = base.investigacions.map(item => ({
          item,
          score: puntuacioAssistent(retrievalQuery, dadesCercaInvestigacio(item))
        })).filter(match => coincideixConsultaAssistent(retrievalQuery, dadesCercaInvestigacio(match.item))).sort((a, b) => b.score - a.score);
        const personMatches = base.persones.map(persona => ({
          persona,
          score: puntuacioAssistent(retrievalQuery, dadesCercaPersona(persona))
        })).filter(match => coincideixConsultaAssistent(retrievalQuery, dadesCercaPersona(match.persona))).sort((a, b) => b.score - a.score || (b.persona.total_adjudicat || 0) - (a.persona.total_adjudicat || 0));
        const subsidyMatches = base.subvencions.map(subvencio => ({
          subvencio,
          score: puntuacioAssistent(retrievalQuery, [subvencio.descripcion, subvencio.adjudicatario, subvencio.codigo, subvencio.finalitat_p_blica])
        })).filter(match => coincideixConsultaAssistent(retrievalQuery, [match.subvencio.descripcion, match.subvencio.adjudicatario, match.subvencio.codigo, match.subvencio.finalitat_p_blica])).sort((a, b) => b.score - a.score || (b.subvencio.importe || 0) - (a.subvencio.importe || 0));
        const genericAlerts = await loadAlertData();
        const alertMatches = Object.entries(genericAlerts).flatMap(([type, items]) => items.map(item => ({
          item,
          type,
          score: puntuacioAssistent(retrievalQuery, dadesCercaAlerta(item, type))
        }))).filter(match => coincideixConsultaAssistent(retrievalQuery, dadesCercaAlerta(match.item, match.type))).sort((a, b) => b.score - a.score || (b.item.risc || 0) - (a.item.risc || 0));
        const contractResults = contractMatches.slice(0, companyMatches.length ? 4 : 6).map(({
          contract
        }) => ({
          type: 'Contracte',
          title: contract.descripcion,
        ...
        const companyResults = companyMatches.slice(0, 2).map(({
          company
        }) => ({
          type: 'Empresa',
          title: company.nom,
        ...
        const investigationResults = investigationMatches.slice(0, 2).map(({
          item
        }) => resultatInvestigacio(item));
        const personResults = personMatches.slice(0, 1).map(({
          persona
        }) => resultatPersona(persona));
        const subsidyResults = subsidyMatches.slice(0, 2).map(({
          subvencio
        }) => resultatSubvencio(subvencio));
        const alertResults = alertMatches.slice(0, 2).map(({
          item,
          type
        }) => ({
          type: `Alerta · ${type === 'concentracio' ? 'concentració' : type === 'dependencia' ? 'dependència' : type}`,
        ...
        results = [...investigationResults, ...alertResults, ...personResults, ...companyResults, ...subsidyResults, ...contractResults].slice(0, 6);
        if (contractMatches.length || investigationMatches.length || personMatches.length || subsidyMatches.length || alertMatches.length) {
          ...
          evidence = [{
            tipus: 'resum',
            investigacions: investigationMatches.length,
            contractes: contractMatches.length,
            import_total: total,
            any: year
          }, ...investigationMatches.slice(0, 4).map(({
            item
          }) => evidenciaInvestigacio(item)), ...alertMatches.slice(0, 4).map(({
            item,
            type
          }) => ({
            tipus: 'alerta',
            ...
            import_total: item.import_total || item.import_concentrat || item.import_sector,
            motius: (item.motius || []).slice(0, 8)
          })), ...personMatches.slice(0, 3).map(({
            persona
          }) => evidenciaPersona(persona)), ...subsidyMatches.slice(0, 4).map(({
            subvencio
          }) => evidenciaSubvencio(subvencio)), ...companyMatches.slice(0, 4).map(({
            company
          }) => ({
            tipus: 'empresa',
            nom: company.nom,
            contractes: company.num_contratos,
            import_total: company.total_importe
          })), ...contractMatches.slice(0, 12).map(({
            contract
          }) => ({
            tipus: 'contracte',
            codi: contract.codigo,
          ...
          evidence = companyMatches.slice(0, 12).map(({
            company
          }) => ({
            tipus: 'empresa',
            nom: company.nom,
      ...
      const errorText = error.code === 'assistant_not_configured' ? 'L’assistent generatiu encara no té configurada la clau API en aquest entorn.' : error.code === 'assistant_rate_limited' ? 'Hi ha massa consultes en aquest moment. Torna-ho a provar d’aquí a un minut.' : error.code === 'assistant_verification_failed' ? 'No he pogut verificar la consulta. Torna-ho a provar d’aquí a uns segons.' : 'No he pogut generar la resposta ara mateix. Torna-ho a provar d’aquí a uns segons.';
      setMessages(current => [...current, {
        id: `error-${Date.now()}`,
        role: 'assistant',
        text: errorText
  ...
  return React.createElement("div", {
    className: `iguadata-assistent${open ? ' is-open' : ''}`
  }, open && React.createElement("section", {
    className: `assistent-panel${closing ? ' is-closing' : ''}`,
    role: "dialog",
    "aria-label": "Assistent de cerca d\u2019Iguadata"
  }, React.createElement("header", {
    className: "assistent-header"
  }, React.createElement("h2", {
    className: "assistent-title"
  }, "Assistent d\u2019Iguadata"), React.createElement("button", {
    type: "button",
    className: "assistent-close",
    onClick: closeAssistant,
    "aria-label": "Tanca l\u2019assistent"
  }, React.createElement(AssistentIcona, {
    close: true
  }))), React.createElement("div", {
    className: "assistent-messages",
    ref: messagesRef,
    "aria-live": "polite"
  }, messages.map(message => React.createElement("div", {
    key: message.id,
    className: `assistent-message is-${message.role}`
  }, React.createElement("p", null, message.text), message.results?.length > 0 && React.createElement("div", {
    className: "assistent-results"
  }, message.results.map((result, index) => React.createElement("a", {
    key: `${message.id}-${index}`,
    className: "assistent-result",
    href: result.href
  }, React.createElement("span", {
    className: "assistent-result-type"
  }, result.type), React.createElement("strong", null, result.title), React.createElement("span", null, result.meta)))))), messages.length === 4 && React.createElement("div", {
    className: "assistent-suggestions",
    "aria-label": "Preguntes suggerides"
  }, ASSISTENT_SUGGERIMENTS.map(suggestion => React.createElement("button", {
    key: suggestion,
    type: "button",
    onClick: () => answerQuestion(suggestion)
  }, suggestion))), loading && React.createElement("div", {
    className: "assistent-thinking",
    role: "status"
  }, React.createElement("span", null), React.createElement("span", null), React.createElement("span", null), React.createElement("span", {
    className: "sr-only"
  }, "Cercant"))), React.createElement("form", {
    className: "assistent-form",
    onSubmit: handleSubmit
  }, React.createElement("label", {
    className: "sr-only",
    htmlFor: "assistent-question"
  }, "Escriu una pregunta"), React.createElement("input", {
    ref: inputRef,
    ...
    "aria-label": "Envia la pregunta"
  }, React.createElement("em", {
    className: "share-arrow",
    "aria-hidden": "true"
  }))), React.createElement("div", {
    className: "assistent-turnstile",
    ref: turnstileContainerRef
  }), React.createElement("p", {
    className: "assistent-note"
  }, "IA generativa basada en les dades p\xFAbliques d\u2019Iguadata.")), (visible || open) && React.createElement("button", {
    type: "button",
    ...
    className: "assistent-trigger-icon is-spark"
  }, React.createElement(AssistentIcona, null)), React.createElement("span", {
    className: "assistent-trigger-icon is-close"
  }, React.createElement(AssistentIcona, {
    close: true
  }))));
}
...
function App() {
  ...
  const activeEntitatSlug = getCurrentRoute().startsWith('/entitats/') ? getCurrentRoute().slice('/entitats/'.length) : null;
  const activeEntitatSubvencions = useMemo(() => activeEntitatSlug ? subvencions.filter(subvencio => subvencio.entitat_slug === activeEntitatSlug) : [], [subvencions, activeEntitatSlug]);
  ...
  useEffect(() => {
    ...
    handleNavigation('subvencions', '/subvencions', {
      replace: true
    });
  ...
  const alertesVisibleTotal = useMemo(() => fraudes.filter(f => f.nivell !== 'BAIX').length + concentracio.length + electoral.filter(f => f.nivell !== 'BAIX').length + dependencia.filter(f => f.nivell !== 'BAIX').length, [fraudes, concentracio, electoral, dependencia]);
  ...
  const homeRiskCounts = useMemo(() => {
    ...
    const levels = [...fraudes, ...concentracio, ...electoral, ...dependencia].map(item => String(item.nivell || '').toUpperCase());
    return {
  ...
  useEffect(() => {
    ...
    const currentPage = analisiTab === 'fraccionament' ? analisiPageFrac : analisiTab === 'monopoli' ? analisiPageMonop : analisiTab === 'electoral' ? analisiPageElect : analisiPageDependencia;
  ...
  const dependenciaFiltrada = useMemo(() => {
    ...
    if (analisiSearch.trim()) {
      result = result.filter(item => matchesSearchQuery([item.entitat, item.cif, item.id, ...(item.motius || []), ...(item.subvencions || []).map(row => row.descripcion)], analisiSearch));
    }
    result = [...result];
    switch (analisiSort) {
      case 'risk-asc':
        result.sort((a, b) => a.risc - b.risc);
        break;
      case 'amount-desc':
        result.sort((a, b) => b.import_total - a.import_total);
        break;
      case 'amount-asc':
        result.sort((a, b) => a.import_total - b.import_total);
        break;
      case 'date-desc':
        result.sort((a, b) => new Date(b.data_fi) - new Date(a.data_fi));
        break;
      case 'date-asc':
        result.sort((a, b) => new Date(a.data_inici) - new Date(b.data_inici));
        break;
      default:
        result.sort((a, b) => b.risc - a.risc);
    }
    return result;
  ...
  if (loading) {
    return React.createElement(HomeLoading, {
  ...
  return React.createElement("div", {
  ...
  }, activeTab !== 'home' && renderSiteChrome(), activeTab === 'home' && React.createElement(React.Fragment, null, React.createElement(HomeChrome, {
    goToHome: goToHome
  ...
  }), homeIntroFading && React.createElement(HomeLoading, {
    isDissolving: true,
    homeCanvasRef: homeCanvasRef,
    loadingProgress: loadingProgress
  }))), activeTab !== 'home' && React.createElement("main", {
    id: "main-content",
    className: "site-main",
    tabIndex: -1
  ...
  }), activeTab === 'subvencions' && canRenderDataTab && React.createElement(SubvencionsView, {
    subvencions: subvencions,
    onEntitatSelect: handleEntitatClick
  }), activeTab === 'entitat' && activeEntitatSubvencions.length > 0 && canRenderDataTab && React.createElement(EntitatView, {
    ...
    onContractSelect: handleDetailClick,
    onEmpresaClick: handleEmpresaClick
  }), activeTab === 'cas-dependencia' && selectedDependenciaDetail && canRenderDataTab && React.createElement(CasDependenciaView, {
    ...
    onKeyDown: handleAnalisiTabKeyDown
  }, "Electoralisme"), React.createElement("button", {
    ...
    onKeyDown: handleAnalisiTabKeyDown
  }, "Depend\xE8ncia")), React.createElement("div", {
    className: 'analisi-mobile-selector' + (isAnalisiMobileMenuOpen ? ' open' : '')
  }, React.createElement("button", {
    ...
    className: "analisi-mobile-current-group"
  }, React.createElement("span", null, analisiTab === 'fraccionament' ? 'Fraccionament' : analisiTab === 'monopoli' ? 'Concentració' : analisiTab === 'electoral' ? 'Electoralisme' : 'Dependència'), React.createElement("svg", {
    className: "analisi-mobile-chevron",
    width: "16",
    height: "16",
    viewBox: "0 0 24 24",
    fill: "none",
    ...
    id: "analisi-mobile-options",
    className: "analisi-mobile-options"
  }, [['fraccionament', 'Fraccionament'], ['monopoli', 'Concentració'], ['electoral', 'Electoralisme'], ['dependencia', 'Dependència']].filter(([value]) => value !== analisiTab).map(([value, label]) => React.createElement("button", {
    key: value,
    ...
    className: "page-title"
  }, analisiTab === 'fraccionament' ? 'Anàlisi de fraccionament' : analisiTab === 'monopoli' ? 'Anàlisi de concentració' : analisiTab === 'electoral' ? "Anàlisi d'electoralisme" : 'Anàlisi de dependència'), React.createElement("p", {
    className: "investigacio-detail-subtitle analisi-page-subtitle"
  }, analisiTab === 'fraccionament' ? "Contractes menors agrupats que poden indicar una possible divisió d'un mateix encàrrec" : analisiTab === 'monopoli' ? "Concentració d'adjudicacions de contractes en una mateixa empresa o xarxa mercantil" : analisiTab === 'electoral' ? 'Contractes de comunicació, difusió o visibilitat pública adjudicats en períodes electorals' : 'Acumulació de subvencions directes en una mateixa entitat'), analisiTab === 'fraccionament' && React.createElement(React.Fragment, null, React.createElement("div", {
    className: "metodologia-wrapper"
  }, React.createElement("div", {
    className: "metodologia"
  }, React.createElement("h3", {
  ...
  })), analisiTab === 'dependencia' && React.createElement(React.Fragment, null, React.createElement("div", {
    className: "metodologia-wrapper"
  }, React.createElement("div", {
    className: "metodologia"
  }, React.createElement("h3", {
    ...
    className: "metodologia-intro"
  }, "L'algoritme Iguadata de depend\xE8ncia detecta entitats que acumulen subvencions directes o les reben de manera recurrent al llarg del temps. La identificaci\xF3 de patrons estad\xEDsticament rellevants i les alertes generades no impliquen cap irregularitat legal confirmada i han de ser interpretades en context."), React.createElement("div", {
    className: "metodologia-steps-compact"
  }, React.createElement("div", {
    className: "metodologia-step-compact"
  }, React.createElement("span", {
    ...
    className: "metodologia-step-text-compact"
  }, "Identificaci\xF3 de subvencions definides com a directes")), React.createElement("div", {
    className: "metodologia-step-compact"
  }, React.createElement("span", {
    className: "metodologia-step-num-compact"
  }, "02"), React.createElement("span", {
    className: "metodologia-step-text-compact"
  }, "Agrupaci\xF3 per entitat i any per mesurar recurr\xE8ncia, continu\xEFtat i acumulaci\xF3")), React.createElement("div", {
    className: "metodologia-step-compact"
  }, React.createElement("span", {
    className: "metodologia-step-num-compact"
  }, "03"), React.createElement("span", {
    ...
    value: analisiSearch,
    onValueChange: setAnalisiSearch,
    placeholder: "Cerca per descripci\xF3, entitat o codi de cas",
    ariaLabel: "Cerca casos de depend\xE8ncia"
  }), React.createElement(FilterActions, {
    open: analisiFiltersOpen,
    onToggle: () => setAnalisiFiltersOpen(prev => !prev),
    activeCount: activeAnalisiFiltersCount,
    onReset: resetAnalisiFilters,
    controlsId: "analisi-filter-panel-dependencia"
  }), React.createElement("div", {
    id: "analisi-filter-panel-dependencia",
    className: "filters search-filter-panel search-filter-panel-analysis" + (!analisiFiltersOpen ? " collapsed" : "")
  }, React.createElement("div", {
    className: "filter-group filter-group-wide"
  }, React.createElement("label", {
    ...
    className: "filter-select filter-select-standard",
    value: analisiSort,
    onChange: event => setAnalisiSort(event.target.value),
    "aria-label": "Ordenar casos de depend\xE8ncia per"
  }, React.createElement("option", {
    value: "risk-desc"
  }, "Puntuaci\xF3 de risc (descendent)"), React.createElement("option", {
    value: "risk-asc"
    ...
    className: "results-count-prefix"
  }, "S'han trobat "), React.createElement("strong", null, dependenciaFiltrada.length), " alertes"), dependenciaFiltrada.length > analisiItemsPerPage && React.createElement("span", {
    className: "results-count-page"
  }, React.createElement("span", {
    className: "results-count-page-full"
  }, "P\xE0gina"), React.createElement("span", {
    className: "results-count-page-short"
  }, "P\xE0g."), " ", React.createElement("strong", null, analisiPageDependencia), " de ", React.createElement("strong", null, totalPagesDependencia))), React.createElement("div", {
    className: "analisi-alert-list"
  }, dependenciaPaginada.map(caso => React.createElement("a", {
    key: caso.id,
    href: buildRouteUrl(`/analisi/dependencia/${caso.id}`),
    className: "card-link-wrapper",
    onClick: event => handleInternalLinkClick(event, () => handleDependenciaClick(caso))
  }, React.createElement("div", {
    className: "contract-card analysis-list-card dependencia-card"
  }, React.createElement("div", {
    className: "contract-header"
  }, React.createElement("div", {
    className: "contract-title"
    ...
    className: "contract-meta-label"
  }, "Acumulaci\xF3"), React.createElement("span", {
    className: "contract-meta-value"
  }, caso.num_subvencions, " subvencions directes")), React.createElement("div", {
    className: "contract-meta-item analysis-list-secondary"
  }, React.createElement("span", {
    ...
    className: "risk-badge " + riskClass(caso.nivell)
  }, caso.risc, "/100"))))))), dependenciaFiltrada.length === 0 && React.createElement(EmptySearchState, {
    text: "No s'han trobat alertes de depend\xE8ncia.",
    onReset: resetAnalisiFilters
  }), dependenciaFiltrada.length > analisiItemsPerPage && React.createElement(Pagination, {
    currentPage: analisiPageDependencia,
    totalPages: totalPagesDependencia,
    onPageChange: setAnalisiPageDependencia
  })))), activeTab === 'sobre' && React.createElement(SobreView, null), activeTab === 'legal' && React.createElement(LegalView, null)), activeTab !== 'home' && React.createElement("button", {
    type: "button",
    ...
    onClick: e => {
      e.preventDefault();
      setAssistantCloseSignal(current => current + 1);
      handleNavigation('home');
    },
  ...
  }, "\xA9 2026 ", BRAND_NAME, ". Tots els drets reservats."))), React.createElement(AssistentIguadata, {
    contracts: contracts,
    empreses: empreses,
    visible: activeTab !== 'home',
    closeSignal: assistantCloseSignal
  }), homeMetricTransition && React.createElement("div", {
